...
if($_SESSION['role']->ROLE==="superadmin"){
    ...
    echo "<div class='container'><a class='btn btn-outline-info mt-3'  href='http://localhost:1313/serveur/SUPER_ADMIN/profil.php'>modifier-تعديل</a></div>"; 
}else{
